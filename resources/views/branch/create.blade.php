...
@section('content')
    ...
    <div class="conatiner-fluid content-inner mt-n5 py-0">
        <div class="row">
            <div class="col-sm-12">
                <form id="inventory_create" action="{{ route('branch.store') }}" method="POST" class="mt-3 ml-15 mr-15">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select type="text" id="branch_type" name="type" class="form-control" required>
